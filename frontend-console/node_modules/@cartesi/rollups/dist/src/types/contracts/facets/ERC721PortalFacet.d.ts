...
export interface ERC721PortalFacet extends BaseContract {
    ...
    functions: {
        ...
        onERC721Received(_operator: PromiseOrValue<string>, _from: PromiseOrValue<string>, _tokenId: PromiseOrValue<BigNumberish>, _data: PromiseOrValue<BytesLike>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    };
    erc721Withdrawal(_data: PromiseOrValue<BytesLike>, overrides?: Overrides & {
    ...
    callStatic: {
        ...
        onERC721Received(_operator: PromiseOrValue<string>, _from: PromiseOrValue<string>, _tokenId: PromiseOrValue<BigNumberish>, _data: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<string>;
    };
    filters: {
