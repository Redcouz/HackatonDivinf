...
export declare namespace CartesiDAppFactory {
    ...
    type FactoryConfigStructOutput = [
        string,
        string,
        string,
...
export interface CartesiDAppFactoryInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "diamondCut" | "diamondCutFacet" | "diamondInit" | "feeManagerBank" | "newApplication"): FunctionFragment;
    encodeFunctionData(functionFragment: "diamondCut", values: [PromiseOrValue<BigNumberish>]): string;
    encodeFunctionData(functionFragment: "diamondCutFacet", values?: undefined): string;
    encodeFunctionData(functionFragment: "diamondInit", values?: undefined): string;
    encodeFunctionData(functionFragment: "feeManagerBank", values?: undefined): string;
    encodeFunctionData(functionFragment: "newApplication", values: [ICartesiDAppFactory.AppConfigStruct]): string;
    decodeFunctionResult(functionFragment: "diamondCut", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "diamondCutFacet", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "diamondInit", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "feeManagerBank", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "newApplication", data: BytesLike): Result;
    events: {
...
export type ApplicationCreatedEvent = TypedEvent<[
    string,
    ICartesiDAppFactory.AppConfigStructOutput
], ApplicationCreatedEventObject>;
export type ApplicationCreatedEventFilter = TypedEventFilter<ApplicationCreatedEvent>;
export interface CartesiDAppFactory extends BaseContract {
    ...
    functions: {
        diamondCut(arg0: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<[string, number] & {
            facetAddress: string;
            action: number;
        }>;
        ...
        newApplication(_appConfig: ICartesiDAppFactory.AppConfigStruct, overrides?: Overrides & {
    ...
    callStatic: {
        ...
        diamondInit(overrides?: CallOverrides): Promise<string>;
        feeManagerBank(overrides?: CallOverrides): Promise<string>;
        newApplication(_appConfig: ICartesiDAppFactory.AppConfigStruct, overrides?: CallOverrides): Promise<string>;
    };
    filters: {
        "ApplicationCreated(address,tuple)"(application?: PromiseOrValue<string> | null, config?: null): ApplicationCreatedEventFilter;
        ApplicationCreated(application?: PromiseOrValue<string> | null, config?: null): ApplicationCreatedEventFilter;
    };
    estimateGas: {
        diamondCut(arg0: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    populateTransaction: {
        diamondCut(arg0: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
