...
export interface DiamondInitInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "init", values: [DiamondConfigStruct]): string;
...
export type FeeManagerInitializedEventFilter = TypedEventFilter<FeeManagerInitializedEvent>;
...
export type RollupsInitializedEventFilter = TypedEventFilter<RollupsInitializedEvent>;
export interface DiamondInit extends BaseContract {
    ...
    functions: {
        init(_dConfig: DiamondConfigStruct, overrides?: Overrides & {
    ...
    callStatic: {
        init(_dConfig: DiamondConfigStruct, overrides?: CallOverrides): Promise<void>;
    };
    filters: {
        "FeeManagerInitialized(uint256,address,address)"(feePerClaim?: null, feeManagerBank?: null, feeManagerOwner?: null): FeeManagerInitializedEventFilter;
        FeeManagerInitialized(feePerClaim?: null, feeManagerBank?: null, feeManagerOwner?: null): FeeManagerInitializedEventFilter;
        "RollupsInitialized(uint256,uint256)"(inputDuration?: null, challengePeriod?: null): RollupsInitializedEventFilter;
        RollupsInitialized(inputDuration?: null, challengePeriod?: null): RollupsInitializedEventFilter;
    };
    estimateGas: {
        init(_dConfig: DiamondConfigStruct, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
