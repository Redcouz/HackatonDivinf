...
export interface IDiamondCut extends BaseContract {
    ...
    filters: {
        "DiamondCut(tuple[],address,bytes)"(diamondCut?: null, init?: null, callData?: null): DiamondCutEventFilter;
        DiamondCut(diamondCut?: null, init?: null, callData?: null): DiamondCutEventFilter;
    };
    estimateGas: {
        diamondCut(_diamondCut: IDiamondCut.FacetCutStruct[], _init: PromiseOrValue<string>, _calldata: PromiseOrValue<BytesLike>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
