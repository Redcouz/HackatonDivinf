...
export interface CartesiMathV2Interface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "clz" | "ctz" | "getLog2Floor" | "getLog2TableTimes1M" | "isPowerOf2" | "log2ApproxTimes1M"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "log2ApproxTimes1M", values: [PromiseOrValue<BigNumberish>]): string;
    ...
    decodeFunctionResult(functionFragment: "log2ApproxTimes1M", data: BytesLike): Result;
    events: {};
}
export interface CartesiMathV2 extends BaseContract {
    ...
    functions: {
        ...
        getLog2Floor(_num: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<[number]>;
        ...
        log2ApproxTimes1M(_num: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<[BigNumber]>;
    };
    clz(_num: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<BigNumber>;
    ctz(_num: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<BigNumber>;
    getLog2Floor(_num: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<number>;
    ...
    populateTransaction: {
        ...
        log2ApproxTimes1M(_num: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
    };
}
