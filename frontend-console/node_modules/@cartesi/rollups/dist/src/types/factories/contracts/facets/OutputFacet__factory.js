...
exports.OutputFacet__factory = void 0;
...
class OutputFacet__factory extends ethers_1.ContractFactory {
    constructor(...args) {
        if (isSuperArgs(args)) {
            ...
            super(_abi, OutputFacet__factory.linkBytecode(linkLibraryAddresses), signer);
        }
    }
    static linkBytecode(linkLibraryAddresses) {
        let linkedBytecode = _bytecode;
        linkedBytecode = linkedBytecode.replace(new RegExp("__\\$f57eb21c11c6dae369da3ca36f4f48eb77\\$__", "g"), linkLibraryAddresses["@cartesi/util/contracts/Bitmask.sol:Bitmask"]
            .replace(/^0x/, "")
            .toLowerCase());
        linkedBytecode = linkedBytecode.replace(new RegExp("__\\$2a7ef22e717e9afc55afc95d018bf1a85b\\$__", "g"), linkLibraryAddresses["@cartesi/util/contracts/MerkleV2.sol:MerkleV2"]
            .replace(/^0x/, "")
            .toLowerCase());
...
exports.OutputFacet__factory = OutputFacet__factory;
OutputFacet__factory.bytecode = _bytecode;
OutputFacet__factory.abi = _abi;
