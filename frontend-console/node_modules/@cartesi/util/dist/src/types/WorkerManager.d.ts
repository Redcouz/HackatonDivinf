...
export interface WorkerManagerInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "acceptJob" | "cancelHire" | "getOwner" | "getUser" | "hire" | "isAvailable" | "isOwned" | "isPending" | "isRetired" | "rejectJob" | "retire"): FunctionFragment;
...
export interface WorkerManager extends BaseContract {
    ...
    functions: {
        ...
        cancelHire(workerAddress: PromiseOrValue<string>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        getOwner(workerAddress: PromiseOrValue<string>, overrides?: CallOverrides): Promise<[string]>;
        getUser(workerAddress: PromiseOrValue<string>, overrides?: CallOverrides): Promise<[string]>;
        hire(workerAddress: PromiseOrValue<string>, overrides?: PayableOverrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        isAvailable(workerAddress: PromiseOrValue<string>, overrides?: CallOverrides): Promise<[boolean]>;
        isOwned(workerAddress: PromiseOrValue<string>, overrides?: CallOverrides): Promise<[boolean]>;
        isPending(workerAddress: PromiseOrValue<string>, overrides?: CallOverrides): Promise<[boolean]>;
        isRetired(workerAddress: PromiseOrValue<string>, overrides?: CallOverrides): Promise<[boolean]>;
        rejectJob(overrides?: PayableOverrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        retire(workerAddress: PromiseOrValue<string>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    };
    acceptJob(overrides?: Overrides & {
    ...
    callStatic: {
        ...
        cancelHire(workerAddress: PromiseOrValue<string>, overrides?: CallOverrides): Promise<void>;
        getOwner(workerAddress: PromiseOrValue<string>, overrides?: CallOverrides): Promise<string>;
        getUser(workerAddress: PromiseOrValue<string>, overrides?: CallOverrides): Promise<string>;
        hire(workerAddress: PromiseOrValue<string>, overrides?: CallOverrides): Promise<void>;
        isAvailable(workerAddress: PromiseOrValue<string>, overrides?: CallOverrides): Promise<boolean>;
        isOwned(workerAddress: PromiseOrValue<string>, overrides?: CallOverrides): Promise<boolean>;
        isPending(workerAddress: PromiseOrValue<string>, overrides?: CallOverrides): Promise<boolean>;
        isRetired(workerAddress: PromiseOrValue<string>, overrides?: CallOverrides): Promise<boolean>;
        rejectJob(overrides?: CallOverrides): Promise<void>;
        retire(workerAddress: PromiseOrValue<string>, overrides?: CallOverrides): Promise<void>;
    };
    filters: {
    ...
    estimateGas: {
        ...
        getUser(workerAddress: PromiseOrValue<string>, overrides?: CallOverrides): Promise<BigNumber>;
        hire(workerAddress: PromiseOrValue<string>, overrides?: PayableOverrides & {
            from?: PromiseOrValue<string>;
        }): Promise<BigNumber>;
        isAvailable(workerAddress: PromiseOrValue<string>, overrides?: CallOverrides): Promise<BigNumber>;
        isOwned(workerAddress: PromiseOrValue<string>, overrides?: CallOverrides): Promise<BigNumber>;
        isPending(workerAddress: PromiseOrValue<string>, overrides?: CallOverrides): Promise<BigNumber>;
        isRetired(workerAddress: PromiseOrValue<string>, overrides?: CallOverrides): Promise<BigNumber>;
        rejectJob(overrides?: PayableOverrides & {
            from?: PromiseOrValue<string>;
        }): Promise<BigNumber>;
        retire(workerAddress: PromiseOrValue<string>, overrides?: Overrides & {
    ...
    populateTransaction: {
        ...
        getUser(workerAddress: PromiseOrValue<string>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        hire(workerAddress: PromiseOrValue<string>, overrides?: PayableOverrides & {
            from?: PromiseOrValue<string>;
        }): Promise<PopulatedTransaction>;
        isAvailable(workerAddress: PromiseOrValue<string>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        isOwned(workerAddress: PromiseOrValue<string>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        isPending(workerAddress: PromiseOrValue<string>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        isRetired(workerAddress: PromiseOrValue<string>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        rejectJob(overrides?: PayableOverrides & {
            from?: PromiseOrValue<string>;
        }): Promise<PopulatedTransaction>;
        retire(workerAddress: PromiseOrValue<string>, overrides?: Overrides & {
