...
export interface IWorkerAuthManagerInterface extends utils.Interface {
    functions: {
...
export interface IWorkerAuthManager extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: IWorkerAuthManagerInterface;
