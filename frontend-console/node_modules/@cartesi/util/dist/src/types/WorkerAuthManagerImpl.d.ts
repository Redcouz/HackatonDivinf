...
export interface WorkerAuthManagerImplInterface extends utils.Interface {
    functions: {
...
export interface WorkerAuthManagerImpl extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: WorkerAuthManagerImplInterface;
