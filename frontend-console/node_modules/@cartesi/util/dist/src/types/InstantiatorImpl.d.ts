...
export interface InstantiatorImplInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "currentIndex" | "getNonce" | "getSubInstances" | "isActive" | "isConcerned"): FunctionFragment;
...
export interface InstantiatorImpl extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: InstantiatorImplInterface;
