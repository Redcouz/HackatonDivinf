...
export interface CartesiTokenTimelockInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "beneficiary" | "release" | "releaseTime" | "token"): FunctionFragment;
...
export interface CartesiTokenTimelock extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: CartesiTokenTimelockInterface;
